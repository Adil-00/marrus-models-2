  ...
  <body>
    ...
    <div class="container">
      <div class="filter-models">
        <ul class="models__filter">
          <li class="item woman">девушки</li>
          <li class="item man">парни</li>
          <li class="item children">дети</li>
          <li class="item sport">спорт</li>
          <li class="item insta">инста</li>
          <li class="item model">модел</li>
          <li class="item tatto">татто</li>
        </ul>

        <ul class="show-by">
          <li class="button">показать по:</li>

          <li class="input">
            росту: от <input placeholder="89см" type="number" /> -до
            <input type="number" placeholder="200см" />
          </li>
          <span>-</span>
          <li class="eye-color">
            <select>
          ...
          <li class="hair-color">
            <select>
              <option value="">цвету волос</option>
    ...
    <div class="container">
      <section class="models">
        <div class="models__model woman">
          <a href="page-detail-models.php"><img src="img/IMG_1464.JPG" alt=""></a>
          <span>Игорь В.</span>
        </div>

        <div class="models__model man">
          <a href="page-detail-models.php"><img src="img/IMG_1464.JPG" alt=""></a>
          <span>Игорь В.</span>
        </div>

        <div class="models__model children">
          <a href="page-detail-models.php"><img src="img/IMG_1464.JPG" alt=""></a>
          <span>Игорь В.</span>
        </div>

        <div class="models__model insta">
          <a href="page-detail-models.php"><img src="img/IMG_1464.JPG" alt=""></a>
          <span>Игорь В.</span>
        </div>

        <div class="models__model sport">
          <a href="page-detail-models.php"><img src="img/IMG_1464.JPG" alt=""></a>
          <span>Игорь В.</span>
        </div>

        <div class="models__model tatto">
          <a href="page-detail-models.php"><img src="img/IMG_1464.JPG" alt=""></a>
          <span>Игорь В.</span>
        </div>
